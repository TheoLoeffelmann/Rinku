...
create table Payments(PaymentId int constraint pk_Payments primary key identity, TotalHours int, TotalPaymetDelivers Decimal(5,2), TotalPaymentBounus decimal(5,2),
	TotaltWithholdings decimal(5, 2), TotalPaymentsGroceryVouchers decimal(5,2), TotalSalary decimal(6,2), Deactivated bit default 0,
